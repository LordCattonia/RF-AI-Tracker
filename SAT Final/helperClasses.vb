...
''' </summary>
''' 
Public Class RfiClass ' classes by convension have to start with a capital letter, I'm not forgetting camelCase.
    ...
    Private Property _imgLoc As String = "" ' Location of a corresponding image
    ...
    Public Property notes As String ' access to change notes for editing, as this is likely to be changed by the user
        Get
            Return _notes
        End Get
        Set(value As String)
    ...
    End Property
    ''' <summary>
    ''' This property indicates whether the RFI is complete or not.
    ''' </summary>
    ''' <remarks>Access to change isComplete for editing, as this will be changed in normal use.</remarks>
    ...
    Private Const AIPrompt As String = "Summarize the following description to 15 words, make sure to include ALL important information" ' Private constant AI prompt to avoid having it inline in the function.
    ''' <summary>
    ...
    Public Sub uncompleteRFI()
        ' Mark the RFI as complete and set the completion date
        _isComplete = False ' Set isComplete to false to reverse the completion
        _dateCompleted = DateTime.MinValue ' Reset the dateCompleted to a dummy value indicating not completed yet
        _daysPast = -1 ' reverse the calculation so it will be recalculated next time it is accessed
    End Sub
End Class
